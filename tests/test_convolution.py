...
import numpy as np
import sys
# sys.path.append(fr'C:\Users\Mohtashim Butt\Desktop\Spring-24\DL\PA2\CNN-from-scratch')
...
class TestForward:
    def test_one(self):
        ...
        input_shape = (3, 8, 8)
        num_filters = 5
        # ConvolutionLayer(in_channel, out_channel, kernel_size, stride)
...
# # My stuff happening here:
# testing_forward = TestBackward()
# testing_forward.test_one()